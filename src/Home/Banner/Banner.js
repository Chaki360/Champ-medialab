            ...
            <div id='default-carousel' className='relative' data-carousel='static'>
                ...
                <div className='overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96'>
                    ...
                    <div className='duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20' data-carousel-item=''>
                        ...
                        <img src={banner1} className='block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2' alt='...'></img>
                    </div>
                    ...
                    <div className='duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-full z-10' data-carousel-item=''>
                        <img src={banner2} className='block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2' alt='...'></img>
                    </div>

                    <div className='duration-700 ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10' data-carousel-item=''>
                        <img src={banner3} className='block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2' alt='...'></img>
                    </div>
                </div>
